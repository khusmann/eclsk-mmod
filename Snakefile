...
rule all:
  input:
    expand('data/res/eclsk2011_study1/mmod/{model}_result.rds', model=config['studies']['eclsk2011_study1']['models']),
    expand('data/res/eclsk2011_study2/mmod/{model}_result.rds', model=config['studies']['eclsk2011_study2']['models'])

rule subset_2011:
  input:
    'data/src/eclsk_2011_childk4.sav'
  output:
    'data/res/eclsk_subset_2011.rds'
  conda:
