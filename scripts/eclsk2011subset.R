...
subsetvars <- c(
  ...
  'T3KEEPS', 'T3SHOWS', 'T3WORKS', 'T3ADAPTS', 'T3FOLLOW', 'T3PERSIS', 'T3ATTEN',
  'T4KEEPS', 'T4SHOWS', 'T4WORKS', 'T4ADAPTS', 'T4FOLLOW', 'T4PERSIS', 'T4ATTEN',
  'T5KEEPS', 'T5SHOWS', 'T5WORKS', 'T5ADAPTS', 'T5FOLLOW', 'T5PERSIS', 'T5ATTEN',
  'T6KEEPS', 'T6SHOWS', 'T6WORKS', 'T6ADAPTS', 'T6FOLLOW', 'T6PERSIS', 'T6ATTEN',
  'T7KEEPS', 'T7SHOWS', 'T7WORKS', 'T7ADAPTS', 'T7FOLLOW', 'T7PERSIS', 'T7ATTEN',
  'G8KEEPS', 'G8SHOWS', 'G8WORKS', 'G8ADAPTS', 'G8FOLLOW', 'G8PERSIS', 'G8ATTEN',
  #'G9KEEPS', 'G9SHOWS', 'G9WORKS', 'G9ADAPTS', 'G9FOLLOW', 'G9PERSIS', 'G9ATTEN',
  ...
  'T6BEZDSL', 'T6BSPTLD', 'T6BLKARQ', 'T6BSPQIK', 'T6BEZDAC', 'T6BEZWAT', 'T6BHTATN', 'T6BHTTLK', 'T6BPYATN', 'T6BDSATN', 'T6BPLANS', 'T6BFLWIN', 'T6BHTSLW',
  'T7BEZDSL', 'T7BSPTLD', 'T7BLKARQ', 'T7BSPQIK', 'T7BEZDAC', 'T7BEZWAT', 'T7BHTATN', 'T7BHTTLK', 'T7BPYATN', 'T7BDSATN', 'T7BPLANS', 'T7BFLWIN', 'T7BHTSLW',
  'G8BEZDSL', 'G8BSPTLD', 'G8BLKARQ', 'G8BSPQIK', 'G8BEZDAC', 'G8BEZWAT', 'G8BHTATN', 'G8BHTTLK', 'G8BPYATN', 'G8BDSATN', 'G8BPLANS', 'G8BFLWIN', 'G8BHTSLW',
  #'G9BEZDSL', 'G9BSPTLD', 'G9BLKARQ', 'G9BSPQIK', 'G9BEZDAC', 'G9BEZWAT', 'G9BHTATN', 'G9BHTTLK', 'G9BPYATN', 'G9BDSATN', 'G9BPLANS', 'G9BFLWIN', 'G9BHTSLW',
